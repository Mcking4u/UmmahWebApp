...
const approvalEndpoint = "/activity/api/validate-activity";
const categoryEndpoint = "/activity/api/getWebcategory";
const addCategoryEndpoint = "/activity/api/addcategory";
const editCategoryEndpoint = "/activity/api/editcategory";
...
const Activity = () => {
  ...
  const handleOpenDialog = (category = null) => {
    ...
    if (category) {
      setCategoryName(category.activity_type);
  ...
  const pendingApprovalColumns = [
    ...
    { field: "activity_type", headerName: "Type", width: 150, flex: 1 },
    {
      field: "action",
      headerName: "Action",
      width: 200,
...
export default withNavUpdate(Activity);
