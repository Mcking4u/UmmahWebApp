...
const approvalEndpoint = "/volunteer/api/validate-volunteer";
const categoryEndpoint = "/volunteer/api/getcategory";
const addCategoryEndpoint = "/volunteer/api/addcategory";
const editCategoryEndpoint = "/volunteer/api/editcategory";
...
const Volunteers = () => {
  ...
  const handleOpenDialog = (category = null) => {
    ...
    if (category) {
      setCategoryName(category.volunteer_type);
  ...
  const pendingApprovalColumns = [
    ...
    { field: "description", headerName: "Need", width: 200, flex: 1 },
    { field: "volunteer_type", headerName: "Type", width: 150, flex: 1 },
    {
      field: "action",
      headerName: "Action",
      width: 200,
      renderCell: (params) => (
        <Box sx={{display:"flex", gap:"5px", alignItems:"center", height:"100%"}}>
         <Button
          size="small"
          startIcon={<Approval />}
          variant="contained"
...
export default withNavUpdate(Volunteers);
