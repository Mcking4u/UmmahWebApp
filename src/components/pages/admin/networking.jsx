...
const approvalEndpoint = "/networking/api/validate-idea";
const categoryEndpoint = "/networking/api/getcategory";
const addCategoryEndpoint = "/networking/api/addcategory";
const editCategoryEndpoint = "/networking/api/editcategory";
...
const Networking = () => {
  ...
  const handleOpenDialog = (category = null) => {
    ...
    if (category) {
      setCategoryName(category.Networking_type);
  ...
  const pendingApprovalColumns = [
    ...
    { field: "idea_type", headerName: "Type", width: 150, flex: 1 },
    {
      field: "action",
      headerName: "Action",
      width: 150,
...
export default withNavUpdate(Networking);
