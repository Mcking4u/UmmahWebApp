...
const approvalEndpoint = "/job/api/validate-job";
const categoryEndpoint = "/job/api/getcategory";
const addCategoryEndpoint = "/job/api/addcategory";
const editCategoryEndpoint = "/job/api/editcategory";
...
const Jobs = () => {
  ...
  const handleOpenDialog = (category = null) => {
    ...
    if (category) {
      setCategoryName(category.job_category);
  ...
  const pendingApprovalColumns = [
    ...
    { field: "title", headerName: "Job Title", width: 150, flex: 1 },
    { field: "description", headerName: "Description", width: 200, flex: 1 },
    { field: "job_type", headerName: "Type", width: 150, flex: 1 },
    {
      field: "action",
      headerName: "Action",
      width: 150,
...
export default withNavUpdate(Jobs);
