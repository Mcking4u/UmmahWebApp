...
const approvalEndpoint = "/event/api/validate-event";
const categoryEndpoint = "/event/api/getcategory";
const addCategoryEndpoint = "/event/api/addcategory";
const editCategoryEndpoint = "/event/api/editcategory";
...
const Events = () => {
  ...
  const handleOpenDialog = (category = null) => {
    ...
    if (category) {
      setCategoryName(category.event_type);
  ...
  const pendingApprovalColumns = [
    ...
    { field: "event_type", headerName: "Type", width: 150, flex: 1 },
    {
      field: "action",
      headerName: "Action",
      width: 150,
...
export default withNavUpdate(Events);
